...
| P1 | `pyroxene_hound` / 辉石猎犬 | 四足机械晶兽，石墨装甲缝隙长出紫青晶体，前爪为切割刃。 | 低矮四足、背脊晶簇。 | 50 HP、12 攻击、6 AP、无护甲，近战、流血威胁。 |
| P1 | `pyroxene_sentry` / 晶涌哨戒机 | 悬浮/三足小型哨戒单元，圆形传感器、侧置能量发射器、晶体散热鳍。 | 单眼核心、三角或三足底盘。 | 86 HP、6 射程、无护甲、无闪避，辉石灼蚀远程单位。 |
